...
export class TodolistService {
  ...
  private url_get = 'http://localhost:8000/api/get_todos';
  private url_post = 'http://localhost:8000/api/add_todo';
  private url_put = 'http://localhost:8000/api/update_todo';
  private url_delete = 'http://localhost:8000/api/delete_todo';
  ...
  editTodo(id:string,description:string):Observable<object>{
    ...
    return this.httpClient.put(this.url_put+'/'+id,data,{observe:'body',}).pipe(catchError(this.handleError<any>('editTodo')));
  }
